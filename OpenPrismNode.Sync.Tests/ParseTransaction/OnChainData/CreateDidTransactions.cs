...
public class CreateDidTransactions
{
    ...
    public async Task CreateDid_Operation_parsed_without_services()
    {
        ...
        // Act
        _parseTransactionHandler = new ParseTransactionHandler(_mediatorMock.Object, _sha256Service, _cryptoService, _logger);
        ...
        result.Value.AsCreateDid().didDocument.PublicKeys[0].X.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[0].Y.Should().NotBeEmpty();
        ...
        result.Value.AsCreateDid().didDocument.PublicKeys[1].X.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[1].Y.Should().NotBeEmpty();
        ...
        result.Value.AsCreateDid().didDocument.PublicKeys[2].X.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[2].Y.Should().NotBeEmpty();
    ...
    public async Task CreateDid_Operation_parsed_with_ED25519()
    {
        ...
        result.Value.AsCreateDid().didDocument.PublicKeys[0].RawBytes.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[0].X.Should().BeNull();
        result.Value.AsCreateDid().didDocument.PublicKeys[0].Y.Should().BeNull();
        ...
        result.Value.AsCreateDid().didDocument.PublicKeys[1].RawBytes.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[1].X.Should().BeNull();
        result.Value.AsCreateDid().didDocument.PublicKeys[1].Y.Should().BeNull();
        result.Value.AsCreateDid().didDocument.PublicKeys[2].KeyId.Should().Be("master0");
        result.Value.AsCreateDid().didDocument.PublicKeys[2].KeyUsage.Should().Be(PrismKeyUsage.MasterKey);
        result.Value.AsCreateDid().didDocument.PublicKeys[2].Curve.Should().Be("secp256k1");
        ...
        result.Value.AsCreateDid().didDocument.PublicKeys[2].X.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[2].Y.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[2].RawBytes.Should().BeEmpty();
        result.Value.AsCreateDid().didDocument.PublicKeys[2].LongByteArray.Should().NotBeEmpty();
        result.Value.AsCreateDid().didDocument.PrismServices.Should().BeEmpty();
    }
