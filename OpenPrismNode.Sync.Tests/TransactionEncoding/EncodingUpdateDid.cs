...
public class EncodingUpdateDid
{
    ...
    [Fact]
    public async Task UpdateDid_roundtrip_encoding_for_Prism_v2()
    {
        // TODO I currently cannot find a PRISM v2 update operation which is not a legacy operation
